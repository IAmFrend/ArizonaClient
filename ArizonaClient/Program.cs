...
namespace ArizonaClient
{
    static class Program
    {
        ...
        //Название приложения
        private const string app_Name = "ArizonaClient";
        /// <summary>
            ...
            if (Create_App)
            {
                ...
                finally
                {
                    ...
                    switch (connect)
                    {
                        ...
                        case false:
                            MessageBox.Show("Ошибка подключения к источнику данных", "ArizonaClient", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            Environment.Exit(0);
                            break;
